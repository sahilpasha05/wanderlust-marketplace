    ...
    >
      <Link to={`/listing/${listing.id}`} className="group block">
        <div className="relative overflow-hidden rounded-2xl aspect-[4/3] bg-muted">
          ...
          <img
            src={listing.images?.[0] ?? "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=800"}
            alt={listing.title}
            loading="lazy"
        ...
        <div className="mt-3 space-y-1">
          ...
          <p className="text-sm">
            <span className="font-semibold text-foreground">{formatCurrency(listing.price_per_night ?? 0)}</span>
