                    ...
                    <div key={b.id} className="bg-background border border-border rounded-2xl p-5 flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 mt-2 text-sm">
                          ...
                          <span className="font-medium text-foreground">{formatCurrency(b.total_price)}</span>
                    ...
                    <div key={w.id} className="bg-background border border-border rounded-2xl overflow-hidden">
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center justify-between mt-3">
                          <span className="text-sm font-semibold">{formatCurrency(w.listings?.price_per_night ?? 0)}/night</span>
